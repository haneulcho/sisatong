...
<!-- 공통 parameter 설정 시작 -->
	...
	<input type="hidden" name="dbpath" value="/fms/CancelDbpath.php" />			<!-- 결과 저장 파일 경로(예:'/regmem/dbpath.php') -->
	<input type="hidden" name="redirpath" value="/fms/CancelRedirpath.php" />	<!-- 결과 화면 파일 경로(예:'/regmem/redirpath.php') -->
<!-- 공통 parameter 설정 끝 -->
